   ...
   return (
      <div>
         <footer className="bg-popover">
            <div className="mx-auto px-4  pb-8 sm:px-6 py-5 lg:px-8">
               <div className="mx-auto flex justify-center gap-3">
                  <div>
                     <Logo />
                  </div>
                  <strong className="block text-center text-xl font-bold text-gray-300 sm:text-3xl">Want us to email you with the latest blockbuster news?</strong>
               </div>
               ...
               <div className="mt-3 border-t border-gray-100 pt-3">
                  <p className="text-center text-xs/relaxed text-gray-500">© Company 20225. All rights reserved.</p>
               </div>
            </div>
         </footer>
      </div>
