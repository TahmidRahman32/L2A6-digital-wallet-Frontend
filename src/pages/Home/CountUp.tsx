...
export function CountUp({
   ...
   return (
      <div
         ...
         className={cn("inline-flex items-center justify-center lg:text-6xl font-bold text-black dark:text-white", className)}
      >
         <motion.div {...getHoverAnimation()} className={cn("flex items-center transition-all", colorClass, numberClassName)} style={colorScheme === "custom" && customColor ? { color: customColor } : undefined}>
