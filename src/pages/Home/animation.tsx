...
export default function Animation({ colorStops = ["#5227FF", "#7cff67", "#5227FF"], amplitude = 1.0, blend = 0.5, speed = 1.0 }: AuroraProps) {
   ...
   return <div ref={containerRef} className="w-full h- absolute bottom-" />;
}
